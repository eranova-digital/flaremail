...
export const SCOPE_ACTION_REQUIREMENTS: Record<ApiKeyScope, AuthAction> = {
	...
	"domain_validation_runs:cancel": "domain_admin",
	...
	"mailboxes:update": "authenticated",
	"mailboxes:delete": "domain_admin",
	"identities:list": "mail_read",
	"identities:create": "authenticated",
	"identities:update": "authenticated",
	"identities:delete": "authenticated",
	"mailbox_grants:list": "domain_manage_users",
	"mailbox_manager_assignments:list": "domain_manage_users",
	"labels:list": "mail_read",
	"labels:create": "mail_write",
	"labels:read": "mail_read",
	"labels:update": "mail_write",
	"labels:delete": "mail_write",
	"templates:list": "authenticated",
	"templates:create": "authenticated",
	"templates:read": "authenticated",
	"templates:update": "authenticated",
	"templates:delete": "authenticated",
	"system_templates:list": "authenticated",
	"system_templates:read": "authenticated",
	"system_templates:update": "authenticated",
	"system_templates:delete": "authenticated",
	"messages:send": "mail_write",
	"drafts:list": "mail_read",
