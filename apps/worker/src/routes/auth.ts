...
export const authRoutes: RouteDefinition[] = [
	...
	{ method: "GET", path: `${prefix}/accounts`, action: "domain_manage_users", handler: handleListAccounts },
	{ method: "GET", path: `${prefix}/accounts/:id`, action: "domain_manage_users", handler: handleGetAccount },
	{ method: "PATCH", path: `${prefix}/accounts/:id`, action: "domain_manage_users", handler: handleUpdateAccount },
	{
		method: "PATCH",
	...
	{ method: "POST", path: `${prefix}/accounts/invite`, action: "domain_manage_users", handler: handleInviteAccount },
	{
		method: "POST",
	...
	{ method: "POST", path: `${prefix}/accounts/assign-role`, action: "domain_manage_users", handler: handleAssignRole },
	{ method: "POST", path: `${prefix}/accounts/:id/suspend`, action: "domain_manage_users", handler: handleSuspendAccount },
	{ method: "POST", path: `${prefix}/accounts/:id/unsuspend`, action: "domain_manage_users", handler: handleUnsuspendAccount },
	{ method: "DELETE", path: `${prefix}/accounts/:id`, action: "domain_manage_users", handler: handleRemoveAccount },
	{
		method: "POST",
	...
	{ method: "POST", path: `${prefix}/oidc-clients`, action: "platform", handler: handleCreateOidcClient },
