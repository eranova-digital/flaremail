...
function buildAutoSubmittedHeaders(
	...
	return [{ key: "Auto-Submitted", value: "auto-generated" }];
}
...
function buildOutboundHeaders(
	...
	return [
		...buildAutoSubmittedHeaders(params.autoGenerated),
...
export function buildEmailSendPayload(
	...
	for (const header of buildOutboundHeaders(params)) {
